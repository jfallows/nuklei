...
import static org.kaazing.nuklei.http.internal.types.control.Types.TYPE_ID_UNCAPTURED_RESPONSE;
...
public final class UncapturedFW extends Flyweight
{
    ...
    public UncapturedFW wrap(DirectBuffer buffer, int offset, int maxLimit)
    {
