...
import static org.kaazing.nuklei.http.internal.types.control.Types.TYPE_ID_PREPARED_RESPONSE;
...
public final class PreparedFW extends Flyweight
{
    ...
    public PreparedFW wrap(DirectBuffer buffer, int offset, int maxLimit)
    {
