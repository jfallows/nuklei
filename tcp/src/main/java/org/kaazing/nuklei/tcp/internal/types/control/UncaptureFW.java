...
public final class UncaptureFW extends Flyweight
{
    ...
    public int typeId()
    {
        return TYPE_ID_UNCAPTURE_COMMAND;
    }
    ...
    {
        return format("UNCAPTURE [correlationId=%d, source=%s]", correlationId(), source());
    }

    public static final class Builder extends Flyweight.Builder<UncaptureFW>
    {
        private final StringFW.Builder sourceRW = new StringFW.Builder();

        public Builder()
        {
            super(new UncaptureFW());
        }
