...
public final class WsEndFW extends Flyweight
{
    ...
    public static final class Builder extends Flyweight.Builder<WsEndFW>
    {
        public Builder()
        {
            super(new WsEndFW());
