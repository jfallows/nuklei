...
public final class PrepareFW extends Flyweight
{
    ...
    @Override
    public PrepareFW wrap(DirectBuffer buffer, int offset, int maxLimit)
    {
        ...
        this.protocolRO.wrap(buffer, destinationRO.limit() + FIELD_SIZE_DESTINATION_REF, maxLimit);
    ...
    public int typeId()
    {
        return TYPE_ID_PREPARE_COMMAND;
    }
    ...
    public static final class Builder extends Flyweight.Builder<PrepareFW>
    {
        ...
        {
            return this.protocolRW.wrap(buffer(), destination().build().limit() + FIELD_SIZE_DESTINATION_REF, maxLimit());
        }
    }
}
