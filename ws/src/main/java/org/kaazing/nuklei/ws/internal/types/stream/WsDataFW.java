...
public final class WsDataFW extends Flyweight
{
    ...
    public WsDataFW wrap(DirectBuffer buffer, int offset, int maxLimit)
    {
    ...
    public static final class Builder extends Flyweight.Builder<WsDataFW>
    {
        public Builder()
        {
            super(new WsDataFW());
