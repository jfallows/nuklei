...
public final class ConductorProxy
{
    ...
    public void onUnboundResponse(
        ...
        String protocol)
    {
        UnboundResponse response = new UnboundResponse(correlationId, destination, destinationRef, source, protocol);
        if (!responseQueue.offer(response))
        {
            throw new IllegalStateException("unable to offer response");
        }
    ...
    public void onUnpreparedResponse(
        ...
        String protocol)
    {
        UnpreparedResponse response = new UnpreparedResponse(correlationId, destination, destinationRef, source, protocol);
        if (!responseQueue.offer(response))
        {
            throw new IllegalStateException("unable to offer response");
        }
