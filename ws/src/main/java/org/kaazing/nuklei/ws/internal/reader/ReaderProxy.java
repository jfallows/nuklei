...
public final class ReaderProxy
{
    ...
    public void doBind(
        ...
        String protocol)
    {
        BindCommand command = new BindCommand(correlationId, destination, destinationRef, source, protocol);
        if (!commandQueue.offer(command))
        {
            throw new IllegalStateException("unable to offer command");
        }
    ...
    public void doPrepare(
        ...
        String protocol)
    {
        PrepareCommand command = new PrepareCommand(correlationId, destination, destinationRef, source, protocol);
        if (!commandQueue.offer(command))
        {
            throw new IllegalStateException("unable to offer command");
        }
