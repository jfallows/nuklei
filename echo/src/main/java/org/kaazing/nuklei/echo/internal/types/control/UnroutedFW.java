...
import static org.kaazing.nuklei.echo.internal.types.control.Types.TYPE_ID_UNROUTED_RESPONSE;
...
public final class UnroutedFW extends Flyweight
{
    ...
    public UnroutedFW wrap(DirectBuffer buffer, int offset, int actingLimit)
    {
    ...
    public int typeId()
    {
        return TYPE_ID_UNROUTED_RESPONSE;
    }
    ...
    {
        return format("UNROUTED [correlationId=%d]", correlationId());
    }
