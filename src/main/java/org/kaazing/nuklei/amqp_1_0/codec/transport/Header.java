...
public final class Header extends FlyweightBE {
    ...
    public Header setProtocol(int value) {
        int32Put(buffer(), offset() + OFFSET_PROTOCOL, value);
        return this;
    }
    ...
    public Header setProtocolID(int value) {
        int8Put(buffer(), offset() + OFFSET_PROTOCOL_ID, (byte) value);
        return this;
    }
    ...
    public Header setMajorVersion(int value) {
        int8Put(buffer(), offset() + OFFSET_MAJOR_VERSION, (byte) value);
        return this;
    }
    ...
    public Header setMinorVersion(int value) {
        int8Put(buffer(), offset() + OFFSET_MINOR_VERSION, (byte) value);
        return this;
    }
    ...
    public Header setRevisionVersion(int value) {
        int8Put(buffer(), offset() + OFFSET_REVISION_VERSION, (byte) value);
        return this;
    }
